...
<section class="container-fluid find-your-adventure no-gutters">
    ...
    if( have_rows('find_your_adventure') ):
        while ( have_rows('find_your_adventure') ) : the_row();
            ...
            $learn_more = get_sub_field('learn_more_link') ? sprintf( '<br /><a href="%s" class="btn btn-primary white">Learn More</a>', get_sub_field('learn_more_link') ) : '';
            if( $i % 2 ) {
                $bg_class = 'show-xxs';
                $bg_class2 = 'hide-xxs';
            } else {
            ...
            $div_text = sprintf('<div class="col-xs-12 col-md-6 fya-content hcenter vcenter" style="background-image: url(%s);"><div class="pad"><h2>%s</h2>%s %s</div></div>',
                #$text_align,
